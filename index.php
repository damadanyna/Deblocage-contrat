...
<body>
    <div class="show-thing" id="show-thing">
        ...
        <div class="c_thing">
            <form class="formulaire_history" style="background: white;" method="POST" action="config.php">
                ...
                <div class="" style=" display:flex">
                    ...
                    <h1>Compte Débloquer Récement</h1>
                </div>
                <div class="c_input">
                    <span class="label_in_">Agence</span>
                ...
                <div class="c_input">
                    <span class="label_in_">cpt_vcode</span>
